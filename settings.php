...
<h1 class="ti-free-title">
		<?php echo TrustindexPlugin::___("Widgets for Trustpilot Reviews"); ?>

<a href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-trustpilot-l" target="_blank" title="Trustindex" class="ti-pull-right">
<img src="<?php  echo $trustindex_pm_trustpilot->get_plugin_file_url('static/img/trustindex.svg'); ?>" />
</a>
</h1>
