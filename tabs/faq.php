...
?>
<div class="maxwidth">
<h1><?php  echo TrustindexPlugin::___("Top questions about the %s free Plugin", ["Widgets for Trustpilot Reviews"]); ?></h1>
<p>
<strong><?php  echo TrustindexPlugin::___('How many %s reviews will be downloaded by the free plugin?', ["Trustpilot"]); ?></strong><br />
	<?php echo TrustindexPlugin::___('The plugin will download 10 %s reviews.', ["Trustpilot"]); ?>
