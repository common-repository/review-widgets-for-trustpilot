...
<li class="<?php  echo !$trustindex_pm_trustpilot->is_noreg_linked() ? "active" : "done"; ?><?php  if($current_step == 1): ?> current<?php  endif; ?>" href="?page=<?php  echo $_GET['page']; ?>&tab=setup_no_reg&step=1">
<span>1</span>
		<?php echo TrustindexPlugin::___('Connect %s platform', [ 'Trustpilot' ]); ?>

</li>
<span class="ti-free-arrow"></span>
<li class="<?php  echo $style_id ? "done" : ($trustindex_pm_trustpilot->is_noreg_linked() ? "active" : ""); ?><?php  if($current_step == 2): ?> current<?php  endif; ?>" href="?page=<?php  echo $_GET['page']; ?>&tab=setup_no_reg&step=2">
<span>2</span>
...
?>
<?php if($current_step == 1 || !$trustindex_pm_trustpilot->is_noreg_linked()): ?>

<h1 class="ti-free-title">
1. <?php  echo TrustindexPlugin::___('Connect %s platform', [ 'Trustpilot' ]); ?>
</h1>
...
<a href="<?php  echo $trustindex_pm_trustpilot->getPageUrl(); ?>" target="_blank"><?php  echo $trustindex_pm_trustpilot->getPageUrl(); ?></a>
</div>
...
<div class="ti-box">
<div class="ti-header"><?php  echo TrustindexPlugin::___('See a %s Widget example below:', [ 'Trustpilot reviews' ]); ?></div>
...
<div class="notice notice-warning" style="margin: 0 0 15px 0">
<p>
				<?php echo TrustindexPlugin::___('There are no reviews on your %s platform.', [ 'Trustpilot' ]); ?>
...
<div class="preview">
						<?php echo $trustindex_pm_trustpilot->get_noreg_list_reviews(null, true, $id, 'light-background', true); ?>
...
<div class="preview">
						<?php echo $trustindex_pm_trustpilot->get_noreg_list_reviews(null, true, $style_id, $id, true); ?>
...
<div class="preview">
<div id="ti-review-list"><?php  echo $trustindex_pm_trustpilot->get_noreg_list_reviews(null, true); ?></div>
...
<div class="ti-select" id="show-star" data-platform="trustpilot">
<font></font>
<ul>
...
<li data-value="4,5" <?php  echo count($filter['stars']) == 2 ? 'class="selected"' : ''; ?>>
								<?php echo $trustindex_pm_trustpilot->get_rating_stars(4); ?> - <?php echo $trustindex_pm_trustpilot->get_rating_stars(5); ?>

</li>
<li data-value="5" <?php  echo count($filter['stars']) == 1 ? 'class="selected"' : ''; ?>>
								<?php echo TrustindexPlugin::___('only'); ?> <?php echo $trustindex_pm_trustpilot->get_rating_stars(5); ?>
...
<input type="hidden" name="command" value="save-language" />
						<?php wp_nonce_field( 'save-language_'.$trustindex_pm_trustpilot->get_plugin_slug(), '_wpnonce_language' ); ?>
...
<input type="hidden" name="command" value="save-dateformat" />
						<?php wp_nonce_field( 'save-dateformat_'.$trustindex_pm_trustpilot->get_plugin_slug(), '_wpnonce_dateformat' ); ?>
...
<input type="hidden" name="command" value="save-options" />
					<?php wp_nonce_field( 'save-options_'.$trustindex_pm_trustpilot->get_plugin_slug(), '_wpnonce_options' ); ?>
...
<label><?php  echo TrustindexPlugin::___("Show platform logos"); ?></label>
						...
						<?php if(!$trustindex_pm_trustpilot->is_ten_scale_rating_platform()): ?>
...
<code class="code-shortcode">[<?php  echo $trustindex_pm_trustpilot->get_shortcode_name(); ?> no-registration=trustpilot]</code>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-trustpilot-1" target="_blank"><?php  echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
<ul class="ti-seo-list">
<li>
<strong><?php  echo TrustindexPlugin::___("%d Review Platforms", [ $trustindex_pm_trustpilot->get_platform_count() ]); ?></strong><br />
...
<img src="<?php  echo $trustindex_pm_trustpilot->get_plugin_file_url('static/img/platforms.png'); ?>" alt="" style="margin-top: 5px" />
</li>
<li>
...
<a class="btn-text" href="https://www.trustindex.io/ti-redirect.php?a=sys&c=wp-trustpilot-2" target="_blank"><?php  echo TrustindexPlugin::___('Create a Free Account for More Features'); ?></a>
</div>
	<?php endif; ?>
